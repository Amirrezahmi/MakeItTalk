...
parser.add_argument('--load_a2l_C_name', type=str, default='/content/MakeItTalk/examples/ckpt/ckpt_audio2landmark_c.pth')
parser.add_argument('--init_content_encoder', type=str, default='/content/MakeItTalk/examples/ckpt/ckpt_audio2landmark_c.pth') #  'tt_lipwpre_prior_useclose/ckpt_last_epoch_20.pth')
