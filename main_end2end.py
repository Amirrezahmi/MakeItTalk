...
parser.add_argument('--load_a2l_G_name', type=str, default='/content/MakeItTalk/examples/ckpt/ckpt_speaker_branch.pth')
...
parser.add_argument('--load_G_name', type=str, default='/content/MakeItTalk/examples/ckpt/ckpt_116_i2i_comb.pth') #ckpt_image2image.pth') #ckpt_i2i_finetune_150.pth') #c
