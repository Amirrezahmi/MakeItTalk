...
parser.add_argument('--load_AUTOVC_name', type=str, default='/content/MakeItTalk/examples/ckpt/ckpt_autovc.pth')
parser.add_argument('--load_a2l_G_name', type=str, default='/content/MakeItTalk/examples/ckpt/ckpt_speaker_branch.pth') #ckpt_audio2landmark_g.pth') #
parser.add_argument('--load_a2l_C_name', type=str, default='/content/MakeItTalk/examples/ckpt/ckpt_content_branch.pth') #ckpt_audio2landmark_c.pth')
parser.add_argument('--load_G_name', type=str, default='/content/MakeItTalk/examples/ckpt/ckpt_116_i2i_comb.pth') #ckpt_i2i_finetune_150.pth') #ckpt_image2image.pth') #
...
for ain in ains:
    ...
    shutil.copyfile('/content/MakeItTalk/examples/tmp.wav', '/content/MakeItTalk/examples/{}'.format(ain))

    # au embedding
    from thirdparty.resemblyer_util.speaker_emb import get_spk_emb
    me, ae = get_spk_emb('/content/MakeItTalk/examples/{}'.format(ain))
...
if(os.path.isfile('/content/MakeItTalk/examples/tmp.wav')):
